              ...
              {customFolders.map((folder: any) => (
                <div key={folder._id} className="group flex items-center justify-between px-3 py-2">
                  <button
                    ...
                    className={`flex items-center space-x-3 text-sm flex-1 py-1 ${
                      selectedFolder === folder._id ? "text-blue-700 font-medium" : "text-gray-700 hover:text-gray-900"
                    }`}
                  >
              ...
              {labels.map((label: any) => (
                <div key={label._id} className="group flex items-center justify-between px-3 py-2">
                  <button
                    ...
                    className={`w-full flex items-center space-x-3 text-sm py-1 ${
