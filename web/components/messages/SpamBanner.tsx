      ...
      {!showContent ? (
        <div className="flex flex-wrap gap-2">
          <Button
            variant="outline"
            size="sm"
            className="border-yellow-500 text-yellow-800 dark:text-yellow-200"
        ...
        <p className="text-sm text-yellow-700 dark:text-yellow-200">
          External content is now visible. Be cautious when clicking links or downloading attachments.
        </p>
      )}
    </div>
  );
